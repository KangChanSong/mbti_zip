...
import com.mbtizip.domain.candidate.person.dto.PersonListDto;
import com.mbtizip.domain.candidate.person.dto.PersonRegisterDto;
...
public class PersonApiController {
    ...
    public CountDto getTotalCount(@RequestParam(value = "keyword", required = false) String keyword,
        ...
        psf.setKeyword(keyword);
        psf.setFilterBy(filterBy);
        return new CountDto(personService.countAll(psf.toPersonKeyword()));
    }
